import angr
b = angr.Project('/mnt/d/WSL/noise/src0.c.out')

# get our state
s = b.factory.entry_state()
# s=b.factory.block(0x40082b)
...
def debug_func(state):
    ...
    print("\n")
    # print(state)
    # print(hex(state.solver.eval(addr)))
    # print(hex(state.solver.eval(expr)))
    # print("State %s is about to do a memory write!")

# s.inspect.b('mem_write', when=angr.BP_AFTER, action=debug_func)
# s.inspect.b('mem_read', when=angr.BP_AFTER, action=debug_func)
...
def hook_clflush_75c(state):
    print("=========75c========")
    # print("rip:"+state.regs.rip)
    print(state)
    print(state.regs.rax)
    print(state.mem[state.regs.rax])

def hook_clflush_79c(state):
    print("=========79c=======")
    # print("rip:"+state.regs.rip)
    print(state)
    print(state.regs.rax)
...
b.hook(addr=0x40075c, hook=hook_clflush_75c, length=4)
b.hook(addr=0x40079c, hook=hook_clflush_79c, length=4)
...
#     print("########################")
#     print(counts.mem_write)
#     print(counts.mem_read)
...
#     p = angr.Project("/mnt/d/WSL/spectre_mem/spectre")
#     constraints = []
